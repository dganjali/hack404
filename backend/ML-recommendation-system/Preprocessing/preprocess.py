...
def load_and_merge_data() -> pd.DataFrame:
    # Absolute paths to each CSV file
    filenames = [
        r"YourFilePath\RawData\Daily shelter occupancy 2017.csv",
        r"YourFilePath\RawData\Daily shelter occupancy 2018.csv",
        r"YourFilePath\RawData\Daily shelter occupancy 2019.csv",
        r"YourFilePath\RawData\Daily shelter occupancy 2020.csv"
    ]
    ...
    output_dir = r"YourFilePath" # name the subdirectory "data" EXACTLY
